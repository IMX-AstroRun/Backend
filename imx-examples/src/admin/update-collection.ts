...
(async (): Promise<void> => {
  ...
  const params: UpdateCollectionParams = {
    icon_url:"https://bafybeibs5wkvypceuwxyv42oi6bcm7gv3vlpl4wcemcfcbyrmpfftnmp6i.ipfs.nftstorage.link",
    metadata_api_url: 'https://bafybeicoq4sjtltc5seepiqkgyt6llko7ps25iokgbte5fkphpwwnaeyvu.ipfs.nftstorage.link',
  };
