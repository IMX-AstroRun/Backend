...
export declare namespace LinkParamsCodecs {
    const Setup: t.PartialC<{
        providerPreference: t.UnionC<[t.LiteralC<ProviderPreference.WALLET_CONNECT>, t.LiteralC<ProviderPreference.METAMASK>, t.LiteralC<ProviderPreference.MAGIC_LINK>, t.LiteralC<ProviderPreference.GAMESTOP>, t.LiteralC<ProviderPreference.NONE>]>;
    }>;
    ...
    const MintByFiat: t.TypeC<{
        contractAddress: t.BrandC<t.StringC, EthAddressBrand>;
        offerId: t.StringC;
        sellerWalletAddress: t.BrandC<t.StringC, EthAddressBrand>;
    }>;
    const Sign: t.TypeC<{
    ...
    const MakeOffer: t.IntersectionC<[t.TypeC<{
        tokenId: t.StringC;
        tokenAddress: t.BrandC<t.StringC, EthAddressBrand>;
    }>, t.PartialC<{
        amount: t.BrandC<t.BrandC<t.StringC, import("./runtime").NumberStringBrand>, import("./runtime").PositiveNumberStringBrand>;
    ...
    const CancelOffer: t.IntersectionC<[t.TypeC<{
        orderId: t.BrandC<t.BrandC<t.StringC, import("./runtime").NumberStringBrand>, import("./runtime").PositiveNumberStringBrand>;
    }>, t.PartialC<{
        fees: t.ArrayC<t.TypeC<{
            recipient: t.BrandC<t.StringC, EthAddressBrand>;
...
export declare namespace LinkParamsF {
    ...
    type MakeOffer = t.TypeOf<typeof LinkParamsCodecs.MakeOffer>;
    type CancelOffer = t.TypeOf<typeof LinkParamsCodecs.CancelOffer>;
}
export declare namespace LinkParams {
    ...
    type MintByFiat = t.OutputOf<typeof LinkParamsCodecs.MintByFiat>;
    type Sign = t.OutputOf<typeof LinkParamsCodecs.Sign>;
    type GetPublicKey = t.OutputOf<typeof LinkParamsCodecs.GetPublicKey>;
    type MakeOffer = t.OutputOf<typeof LinkParamsCodecs.MakeOffer>;
    type CancelOffer = t.OutputOf<typeof LinkParamsCodecs.CancelOffer>;
}
export declare namespace LinkResultsCodecs {
    ...
    const FiatToCrypto: t.TypeC<{
        exchangeId: import("io-ts-types").NonEmptyStringC;
    }>;
    const CryptoToFiat: t.TypeC<{
        exchangeId: import("io-ts-types").NonEmptyStringC;
    }>;
    const MintByFiat: t.TypeC<{
        transactionId: t.StringC;
    }>;
    const MakeOffer: t.TypeC<{
        orderId: t.StringC;
        status: t.StringC;
    }>;
}
...
export declare namespace LinkResults {
    ...
    type FiatToCrypto = t.OutputOf<typeof LinkResultsCodecs.FiatToCrypto>;
    type CryptoToFiat = t.OutputOf<typeof LinkResultsCodecs.CryptoToFiat>;
    type MintByFiat = t.OutputOf<typeof LinkResultsCodecs.MintByFiat>;
    type MakeOffer = t.OutputOf<typeof LinkResultsCodecs.MakeOffer>;
}
export {};
