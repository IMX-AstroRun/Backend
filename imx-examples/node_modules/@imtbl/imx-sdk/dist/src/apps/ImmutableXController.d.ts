...
export declare class ImmutableXController {
    ...
    transferAsync(from: TransferParams, to: TransferParams, token: Token, assetId: string, quantity: PositiveBigNumber, nonce: string, expirationTimestamp: string): Promise<string>;
