...
import { AddMetadataSchemaToCollectionParams, AddMetadataSchemaToCollectionResult, CreateCollectionParams, CreateCollectionsResult, CreateProjectParams, CreateProjectResult, ERC721Token, EthAddress, ExchangeProvider, GetAwaitingOrderStatusResponse, GetMetadataSchemaParams, GetMetadataSchemaResult, GetProjectParams, HexadecimalString, ImmutableCreateNFTPrimaryTransactionParams, ImmutableCreateNFTPrimaryTransactionResponse, ImmutableExchangeType, ImmutableGetNFTPrimaryTransactionsHistoryResult, ImmutableGetNFTPrimaryTransactionStatusResponse, ImmutableGetPrimaryTransactionsHistoryParams, ImmutableGetPrimaryTransactionsHistoryParamsTS, ImmutableMethodParams, ImmutableMethodResults, MintableERC721Token, OrderParams, PositiveBigNumber, ProjectResult, ProjectsResult, Token, UpdateCollectionParams, UpdateCollectionsResults, UpdateMetadataSchemaByNameParams, UpdateMetadataSchemaByNameResult, VerifyOTPParams, VerifyOTPResponse } from '../types';
...
export declare class ImmutableXClient {
    ...
    private signEthMessageAsync;
    private signEthMessage;
    ...
    private post;
    private delete;
    registerImxF(params: ImmutableMethodParams.ImmutableRegisterParams): TE.TaskEither<Error, ImmutableMethodResults.ImmutableRegisterResult>;
    fullWithdrawal(contractAddress: string, starkPublicKey: string, vaultId: string): Promise<string>;
    ...
    private createAssessableTradeF;
    private createAssessableTrade;
    ...
    decodeImmutableGetSignableTransferV2Result(result: any): E.Either<never, {
        ...
        signable_message: any;
    }>;
    private decodeForFunction;
    private signableTransferDetails;
    createExchangeTransfer(exchangeId: number, { sender, token, quantity, receiver, }: ImmutableMethodParams.ImmutableTransferParams): Promise<ImmutableMethodResults.ImmutableTransferResult>;
    createExchange(walletAddress: string, provider?: ExchangeProvider, type?: string): Promise<ImmutableMethodResults.ImmutableCreateExchangeResult>;
    getExchange(exchange_id: number): Promise<ImmutableMethodResults.ImmutableGetExchangeResult>;
    getMoonpaySignature(req: ImmutableMethodResults.ImmutableGetMoonpaySignatureRequest): Promise<ImmutableMethodResults.ImmutableGetMoonpaySignatureResult>;
    getMoonpaySellSignature(req: ImmutableMethodResults.ImmutableGetMoonpaySellSignatureRequest): Promise<ImmutableMethodResults.ImmutableGetMoonpaySignatureResult>;
    getMoonpayPrimarySellSignature(req: ImmutableMethodResults.ImmutableGetMoonpayPrimarySellSignatureRequest): Promise<ImmutableMethodResults.ImmutableGetMoonpaySignatureResult>;
    handleSignatureRequest(body: any): Promise<{
        request: string;
        signature: string;
    }>;
    getCurrencies(exchangeType: ImmutableExchangeType): Promise<ImmutableMethodResults.ImmutableGetCurrenciesResult>;
    getCurrencyLimits(provider?: ExchangeProvider): Promise<ImmutableMethodResults.ImmutableGetCurrencyLimitsResult>;
    ...
    getAwaitingOrderStatus(requestId: string): Promise<GetAwaitingOrderStatusResponse>;
    createTradeWithRiskAssessment(params: ImmutableMethodParams.ImmutableGetSignableTradeParamsTS): Promise<ImmutableMethodResults.ImmutableCreateTradeResult>;
    createNFTPrimaryTransaction(params: ImmutableCreateNFTPrimaryTransactionParams): Promise<ImmutableCreateNFTPrimaryTransactionResponse>;
    getNFTPrimaryTransactionStatus(transactionId: string): Promise<ImmutableGetNFTPrimaryTransactionStatusResponse>;
    getPrimaryTransactionsHistoryF(params?: ImmutableGetPrimaryTransactionsHistoryParams): TE.TaskEither<Error, ImmutableGetNFTPrimaryTransactionsHistoryResult>;
    getPrimaryTransactionsHistory(params?: ImmutableGetPrimaryTransactionsHistoryParamsTS): Promise<ImmutableGetNFTPrimaryTransactionsHistoryResult>;
}
